...
class Aadhar_OCR:
    ...
    def extract_data(self):
        ...
        aadhar_date_time = datetime.strptime(date_str, '%d/%m/%Y').date()

        self.user_dob = aadhar_date_time
        ...
        # for i in self.user_aadhar_no:
        #     if i == ' ':
        #         number1 = number1
        #     else:
        #         number1 += i
        # self.user_aadhar_no = number1
        self.user_aadhar_no = self.user_aadhar_no.replace(" ", "")
    ...
    def commit_changes(self, aadhar_no, gender, dob, name):
        ...
        mydb = mc.connect(host='localhost', user='root', database='fyp_aadhar')
